...
const Sidebar = ({
  ...
  return (
    <>
      ...
      <div
        className={`relative flex h-screen min-w-[350px] max-w-[350px] flex-col border-r border-base-300/50 bg-base-100 ${showSidebar ? "" : "hidden"}`}
      >
        <button
          className="absolute -right-0 top-1/2 z-50 -translate-y-1/2 translate-x-1/2 rounded-full border border-base-300/50 bg-base-100 p-3 shadow-apple transition-all hover:bg-base-200 active:scale-95"
          onClick={() => setShowSidebar((prev) => !prev)}
        >
          <ChevronLeftIcon className="h-4 w-4 text-base-content/70" />
        </button>
